...
@section('content')
        <h1>Se connecter en tant que musicien</h1>
        <form action="{{route('connexion_musicien')}}" method="POST">
            {{ csrf_field() }}
        ...
        <a class="btn btn-block btn-info" href="{{route('inscription_musicien')}}">Vous n'êtes pas encore inscrit ? Cliquez ici pour le faire !</a>
@endsection
